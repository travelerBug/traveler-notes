...
![image-20220916153323290](https://downloadflies.com/blog-img/image-20220916153323290.png)
...
![image-20220916153347452](https://downloadflies.com/blog-img/image-20220916153347452.png)

切片的结构体由3部分构成，Pointer 是指向一个数组的指针，len 代表当前切片的长度，cap 是当前切片的容量。cap 总是大于等于 len 的。

![image-20220916153403218](https://downloadflies.com/blog-img/image-20220916153403218.png)
...
![image-20220916153049959](https://downloadflies.com/blog-img/image-20220916153049959.png)
...
![image-20220916153116560](https://downloadflies.com/blog-img/image-20220916153116560.png)

这里是用字面量创建的一个 len = 6，cap = 6 的切片，这时候数组里面每个元素的值都初始化完成了。需要注意的是 [ ] 里面不要写数组的容量，因为如果写了个数以后就是数组了，而不是切片了。

![image-20220916153421648](https://downloadflies.com/blog-img/image-20220916153421648.png)
...
![image-20220916153135422](https://downloadflies.com/blog-img/image-20220916153135422.png)
...
![image-20220916153438375](https://downloadflies.com/blog-img/image-20220916153438375.png)
...
![image-20220916153159949](https://downloadflies.com/blog-img/image-20220916153159949.png)
...
![image-20220916153219432](https://downloadflies.com/blog-img/image-20220916153219432.png)
...
![image-20220916153244420](https://downloadflies.com/blog-img/image-20220916153244420.png)
...
![image-20220916153305714](https://downloadflies.com/blog-img/image-20220916153305714.png)
